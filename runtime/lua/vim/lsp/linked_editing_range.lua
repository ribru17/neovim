...
--- changed.
---
--- View the LSP's specification: https://microsoft.github.io/language-server-protocol/specification/#textDocument_linkedEditingRange
...
local function toggle_linked_editing_for_client(enable, client)
  ...
  if enable then
    api.nvim_create_autocmd('LspAttach', {
      group = group,
      desc = 'Enable linked editing ranges for all buffers this client attaches to',
